...
public class PatWristbandFile extends PatientHealthModel {
    private Long wristband_file_id;
    ...
    public Long getWristband_file_id() {
        return wristband_file_id;
    }

    public void setWristband_file_id(Long wristband_file_id) {
        this.wristband_file_id = wristband_file_id;
    }
