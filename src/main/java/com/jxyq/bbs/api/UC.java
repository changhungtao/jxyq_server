...
public class UC extends HttpServlet {
    ...
    private String doAnswer(HttpServletRequest request, HttpServletResponse response) {
        ...
        if ($action.equals("test")) {
            ...
            System.out.println("Received deleteuser message.");
            return API_RETURN_SUCCEED;

        } else if ($action.equals("renameuser")) {
            System.out.println("Received renameuser message.");
            return API_RETURN_SUCCEED;
            ...
            System.out.println("Received updatepw message.");
            String $password = $get.get("password");
            String $username = $get.get("username");
            changeUserBbsPassword($username, $password);
            return API_RETURN_SUCCEED;
    ...
    private void changeUserBbsPassword(String username, String password) {
