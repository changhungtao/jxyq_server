 ...
 * @export
 */
jxmgrsec.modify_doctor_modal.Ctrl.$inject = [
    "$scope",
    "$filter",
    "$modalInstance",
    '$q',
...
//    }];
    ...
    $scope.checkParam = function() {
        ...
        // if (!validParam($scope.signUpInf.gender)) {
        //     console.log($scope.signUpInf.gender);
        //     $scope.addAlert("danger", "请输入性别！");
        //     return false;
        // }
        if (validParam($scope.birthday_date)) {
//            $scope.signUpInf.birthday = $scope.toDDMMMYYYY($scope.birthday_date);
