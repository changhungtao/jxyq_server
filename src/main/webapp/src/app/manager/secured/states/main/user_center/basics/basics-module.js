 ...
 */
jxmgrsec.main.user_center.basics.module = angular.module('main.user_center.basics', [
  'ui.router'
]);
 ...
 */
jxmgrsec.main.user_center.basics.module
.config(jxmgrsec.main.user_center.basics.module.configuration)
.controller('BasicsCtrl', jxmgrsec.main.user_center.basics.Ctrl);
