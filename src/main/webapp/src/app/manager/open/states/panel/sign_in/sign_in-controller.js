...
goog.provide('jxmgropn.panel.sign_in.Ctrl');

jxmgropn.panel.sign_in.Ctrl.$inject = [
  "$window",
  'basic',
  '$rootScope',
  'md5',
...
jxmgropn.panel.sign_in.Ctrl = function($window, basic, $rootScope, md5, $timeout) {
 var ctrl=this;
 ...
 ctrl.userLoginInfo = {
  ...
  ctrl.signIn = function(){
    ...
    .then(function(res){
      ...
      $window.location.href = '/manager/secured';
    }, function(error){
