...
jxmgropn.panel.sign_in.Ctrl.$inject = ["$window", "basic", "$rootScope", "md5", "$timeout"];
jxmgropn.panel.sign_in.Ctrl = function($window, basic, $rootScope, md5, $timeout) {
  var ctrl = this;
  ctrl.userLoginInfo = {login_name:"", password:"", captcha:"", role:"manager"};
  ctrl.password = "";
...
jxmgropn.panel.sign_in.module = angular.module("panel.sign_in", ["ui.router", "ui.bootstrap", "angular-md5"]);
...
jxmgropn.panel.sign_in.module.config(jxmgropn.panel.sign_in.module.configuration).controller("SignInCtrl", jxmgropn.panel.sign_in.Ctrl);
goog.provide("jxmgropn.panel.module");
goog.require("jxmgropn.panel.sign_in.module");
goog.require("jxmgropn.panel.Ctrl");
jxmgropn.panel.module = angular.module("panel", ["ui.router", jxmgropn.panel.sign_in.module.name]);
...
jxmgropn.panel.module.config(jxmgropn.panel.module.configuration).controller("PanelCtrl", jxmgropn.panel.Ctrl);
...
jxmgropn.basic.Service.$inject = ["$rootScope", "$http", "$q"];
...
angular.module("app", ["ui.router", "ngResource", jxmgropn.panel.module.name]).config(config).run(onChangeConfig).run(endPointConfig).directive("version", jxmgropn.version.Directive.factory).service("version", jxmgropn.version.Service).filter("check", jxmgropn.check.Filter.factory).service("basic", jxmgropn.basic.Service);
